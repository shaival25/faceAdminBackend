...
const AtlasBnyGeneral = atlasConnection.model(
  "BnyGeneral",
  bnyGeneralSchema,
  "bnygenerals"
);
const AtlasBus = atlasConnection.model("Bus", busSchema, "buses");
const AtlasFeedback = atlasConnection.model(
  "Feedback",
  feedbackSchema,
  "feedbacks"
);
const AtlasPersonCounter = atlasConnection.model(
  "PersonCounter",
  personCounterSchema,
  "personcounters"
);
const AtlasSipCalc = atlasConnection.model(
  "SipCalc",
  sipCalcSchema,
  "sipcalcs"
);
const AtlasUserAnalytics = atlasConnection.model(
  "UserAnalytics",
  userAnalyticsSchema,
  "useranalytics"
);
const AtlasHeatMap = atlasConnection.model(
  "HeatMap",
  heatMapSchema,
  "heatmaps"
);
